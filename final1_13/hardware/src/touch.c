...
#define YOUR_AREA1_X_START 120
#define YOUR_AREA1_X_END 152
#define YOUR_AREA1_Y_START 280
#define YOUR_AREA1_Y_END 312

#define YOUR_AREA2_X_START 160
#define YOUR_AREA2_X_END 192
#define YOUR_AREA2_Y_START 280
#define YOUR_AREA2_Y_END 312
...
{			   
	...
	}else
	{
     ...
     if(tp_dev.x[0] >= YOUR_AREA1_X_START && tp_dev.x[0] <= YOUR_AREA1_X_END && tp_dev.y[0] >= YOUR_AREA1_Y_START && tp_dev.y[0] <= YOUR_AREA1_Y_END)
    {
        
        BEEP=1;
    }
    
    if(tp_dev.x[0] >= YOUR_AREA2_X_START && tp_dev.x[0] <= YOUR_AREA2_X_END && tp_dev.y[0] >= YOUR_AREA2_Y_START && tp_dev.y[0] <= YOUR_AREA2_Y_END)
    {
